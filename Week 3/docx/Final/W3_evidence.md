...
![RDS Subnet Configuration](../Database%20Layer/Screenshot/image.png)
...
![RDS Security Group Inbound Rules](../Database%20Layer/Screenshot/image1.png)
...
![RDS Instance Configuration 1](../Database%20Layer/Screenshot/image2.png)
![RDS Instance Configuration 2](../Database%20Layer/Screenshot/image3.png)
![RDS Instance Configuration 3](../Database%20Layer/Screenshot/image4.png)
![RDS Instance Configuration 4](../Database%20Layer/Screenshot/image5.png)
...
![ECS Task Definition Secrets](../Database%20Layer/Screenshot/image6.png)
...
![RDS Backup Configuration](../Database%20Layer/Screenshot/image7.png)
...
![JOIN Query Results](../Database%20Layer/Screenshot/image8.png)
...
![Indexed Lookup EXPLAIN Plan](../Database%20Layer/Screenshot/image9.png)
...
- **1.2. Tạo dữ liệu mẫu:** Tạo sẵn 3 file text (`.txt` hoặc `.json`) để test ghi thông tin 3 sản phẩm của bạn (ví dụ: `sp1.txt`, `sp2.txt`, `sp3.txt`) và nhấn Upload vào bucket S3 này.
  ...
  ![S3 Bucket Sample Data](../AI%20Bedrock%20Layer%20-%20Knowledge%20Base%20+%20Retrieval/Sceenshot/1_2.png)
...
- **1.7. Embeddings Model:** Chọn mô hình **Titan Embeddings V2** hoặc **Titan Embeddings G1**.
  ...
  ![Embeddings Model Selection](../AI%20Bedrock%20Layer%20-%20Knowledge%20Base%20+%20Retrieval/Sceenshot/1_7.png)
...
- **1.10. Test Knowledge Base:** Chọn model **Nova 2 Lite** để test. Kết quả cho thấy AI trả lời chính xác và có dẫn nguồn rõ ràng:
  ...
  ![Knowledge Base Test Results](../AI%20Bedrock%20Layer%20-%20Knowledge%20Base%20+%20Retrieval/Sceenshot/2_0.png)
...
![Lambda IAM Policy](../AI%20Bedrock%20Layer%20-%20Knowledge%20Base%20+%20Retrieval/Sceenshot/policy.jpg)
...
- **Biến môi trường (Environment Variables):**
  ...
  ![Lambda Environment Variables](../AI%20Bedrock%20Layer%20-%20Knowledge%20Base%20+%20Retrieval/Sceenshot/env.jpg)
...
![S3 Gateway Endpoint](../VPC%20và%20Networking%20-%20Multi-Tier%20+%20Gateway%20Endpoint/Screenshot/S3%20Gateway%20Endpoint.png)
...
![Database Inbound rules](../VPC%20và%20Networking%20-%20Multi-Tier%20+%20Gateway%20Endpoint/Screenshot/Database%20Inbound%20rules.png)
...
![ECS Inbound rules](../VPC%20và%20Networking%20-%20Multi-Tier%20+%20Gateway%20Endpoint/Screenshot/ECS%20Inbound%20rules.png)

![Lambda Inbound rules](../VPC%20và%20Networking%20-%20Multi-Tier%20+%20Gateway%20Endpoint/Screenshot/Lambda%20Inbound%20rules.png)
...
![ALB Inbound rules](../VPC%20và%20Networking%20-%20Multi-Tier%20+%20Gateway%20Endpoint/Screenshot/ALB%20Inbound%20rules.png)
...
**Tình huống:** Nhóm sẽ sử dụng Network ACL (NACL) thay cho Security Group trong trường hợp cần phải **CHẶN MỘT CÁCH TƯỜNG MINH (DENY)** traffic từ một địa chỉ IP độc hại cụ thể (ví dụ: đang bị tấn công DDoS từ một IP/dải IP đã biết).
...
![Scenario 1 - Internet Access Test](../Negative%20Security%20Test/scenario-1/scenario-1.png)
...
![Scenario 1 - EC2 Internal Access Test](../Negative%20Security%20Test/scenario-1/scenario-2.png)
...
![Scenario 1 - Direct Backend Access Test](../Negative%20Security%20Test/scenario-1/scenario-3.png)
...
![Scenario 2 - External Negative Test](../Negative%20Security%20Test/scenario-2/scenario-1.png)
...
![Scenario 2 - Internal Negative Test](../Negative%20Security%20Test/scenario-2/scenario-2.png)
...
![Scenario 2 - Positive Test](../Negative%20Security%20Test/scenario-2/scenario-3.jpg)
...
![WAF FFUF Detection](../Negative%20Security%20Test/waf/fuff/fuff-1.png)

![WAF FFUF Blocked Request](../Negative%20Security%20Test/waf/fuff/ffuf-2.png)
...
![WAF XSS Detection 1](../Negative%20Security%20Test/waf/xss/xss-1.png)

![WAF XSS Detection 2](../Negative%20Security%20Test/waf/xss/xss-2.png)

![WAF XSS Detection 3](../Negative%20Security%20Test/waf/xss/xss-3.png)
...
- Goal: [dien vao]
- Pre-change evidence (screenshot/timing): [paste path/link]
- Post-change evidence (screenshot/timing): [paste path/link]
- Reflection: [hoc duoc gi, trade-off]
